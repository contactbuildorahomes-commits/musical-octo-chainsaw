...
export const meta = () => [
  { title: "Briefly — Sign In" },
  { name: "description", content: "Sign in to your Briefly account." },
  { property: "og:title", content: "Briefly — Sign In" },
  { property: "og:description", content: "Access your AI workspace and tools." },
  { property: "og:image", content: import.meta.env.NEXT_PUBLIC_OG_IMAGE || "" },
  { name: "twitter:title", content: "Briefly — Sign In" },
  { name: "twitter:description", content: "Access your AI workspace and tools." },
